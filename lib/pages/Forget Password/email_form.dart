              ...
              children: [
                ...
                Align(
                    ...
                    child: Padding(
                      ...
                      child: Text("Forgot Password",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: colorHelper.colors[1],letterSpacing: 1),),
                    )
                ),
                Align(
                    alignment: Alignment.centerLeft,
                    child: Padding(
                      padding: const EdgeInsets.only(left: 18),
                      child: Text("Please enter the email you've attached with your account",style: TextStyle(fontSize: 10,color: colorHelper.colors[2]),),
                    )
                ),
                Padding(
                  padding: const EdgeInsets.only(left: 18,right: 18,top: 40),
                  child: forgot_pass_feild(),
                ),
                SizedBox(height: 50,),
                InkWell(
                  onTap: ()async{
                    await Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => loading()), (route) => false);
