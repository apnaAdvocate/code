  ...
  return Container(
    ...
    decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
            ...
            colors: [
              colorHelper.rgb[13],
              colorHelper.rgb[14].withOpacity(0.30)
            ]
        )
    ),
    child: Stack(
      children: [
        Align(
          ...
          child: Padding(
            ...
            child: Text("Land Details",style: TextStyle(fontSize: 14,color: colorHelper.colors[1],fontWeight: FontWeight.bold),),
          ),
        ),
        Align(
