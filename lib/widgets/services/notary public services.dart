...
Widget notary_public_services_card(){
  return Container(
    height: 120,
    ...
    decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
            ...
            colors: [
              colorHelper.rgb[5],
              colorHelper.rgb[6].withOpacity(0.30)
            ]
        )
    ),
    child: Stack(
      children: [
        Align(
          ...
          child: Padding(
            ...
            child: Text("Notary Public Service",style: TextStyle(fontSize: 14,color: colorHelper.colors[1],fontWeight: FontWeight.bold),),
          ),
        ),
        Align(
