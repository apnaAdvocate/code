  ...
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      gradient: LinearGradient(
        ...
        colors: [
          colorHelper.rgb[3],
          colorHelper.rgb[4].withOpacity(0.30)
        ]
      )
    ),
    child: Stack(
      children: [
        Align(
          ...
          child: Padding(
            ...
            child: Text("Rent Agreement",style: TextStyle(fontSize: 16,color: colorHelper.colors[1],fontWeight: FontWeight.bold),),
          ),
        ),
        Align(
          ...
          child: ClipRRect(
            ...
            child: Image.asset(assets.icon3),
          ),
        ),
        Align(
          alignment: Alignment.topLeft,
